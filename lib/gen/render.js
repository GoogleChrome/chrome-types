 ...
 *
 * This automatically filters to nodes that are supported for regular extensions (i.e., not platform
 * apps only), and which are supported in Manifest V3+.
 * 
 * The input can be filtered to nodoc if required.
 *

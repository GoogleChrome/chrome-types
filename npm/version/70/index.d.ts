...
// Generated on Thu Dec 17 2020 17:37:35 GMT+1100 (Australian Eastern Daylight Time)
 ...
 */
  export namespace automation {
     ...
     */
    export type ActionType = "blur" | "clearAccessibilityFocus" | "customAction" | "decrement" | "doDefault" | "focus" | "getImageData" | "hitTest" | "increment" | "loadInlineTextBoxes" | "replaceSelectedText" | "scrollBackward" | "scrollDown" | "scrollForward" | "scrollLeft" | "scrollRight" | "scrollToMakeVisible" | "scrollToPoint" | "scrollUp" | "setAccessibilityFocus" | "setScrollOffset" | "setSelection" | "setSequentialFocusNavigationStartingPoint" | "setValue" | "showContextMenu";
 ...
 */
  export namespace declarativeNetRequest {
    ...
    export interface RuleCondition {
       ...
       * If omitted, all urls are matched. An empty string is not allowed. Note: The
       * urlFilter must be composed of only ASCII characters. This is matched against
       * a url where the host is encoded in the punycode format (in case of
       * internationalized domains) and any other non-ascii characters are url encoded
       * in utf-8. For example, when the request url is http://abc.рф?q=ф, the
       ...
       * are also allowed. The entries must consist of only ascii characters. Use
    ...
    /**
     * Adds |page_patterns| to the set of allowed pages. Requests from these pages
     * are not intercepted by the extension. These are persisted across browser
     * sessions. Note: MAX_NUMBER_OF_ALLOWED_PAGES is the maximum number of allowed
     * page an extension can add. Also, adding page patterns is atomic. In case of
     * an error, no page pattern is added.
     * @param page_patterns Array of match patterns which are to be allowed.
    ...
    /**
     * Removes |page_patterns| from the set of allowed pages. Note: Removing page
     * patterns is atomic. In case of an error, no page pattern is removed.
     * @param page_patterns Array of match patterns which are to removed.
...
declare namespace chrome {
  ...
  export namespace tabs {
     ...
     * href='activeTab'>activeTab</a> permission. In addition to sites extensions
     ...
     * with the activeTab permission. File URLs may be captured only if the
  ...
  export namespace windows {
    ...
    export function update(
      ...
      updateInfo: {
        ...
        /**
         * If true, brings the window to the front and cannot be combined with the state
         * 'minimized'. If false, brings the next window in the z-order to the front and

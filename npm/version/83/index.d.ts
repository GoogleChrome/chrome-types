...
// Generated on Thu Dec 17 2020 17:36:19 GMT+1100 (Australian Eastern Daylight Time)
 ...
 */
  export namespace declarativeNetRequest {
     ...
     */
    export type HeaderOperation = "remove";

    /**
     * Describes the kind of action to take if a given RuleCondition matches.
     */
    export type RuleActionType = "block" | "redirect" | "allow" | "upgradeScheme" | "removeHeaders" | "modifyHeaders" | "allowAllRequests";
    ...
    export interface Rule {
      ...
      /**
       * Rule priority. Mandatory for all rules other than removeHeaders, and should
       * be >= 1. This is used to break ties between multiple matching rules.
       */
      priority?: number;
     ...
     * @param callback Called once the list of matched rules has been fetched. In case of an error, {@link runtime.lastError} will be set to denote the error and no rules will be returned. This can happen for multiple reasons, such as insufficient permissions, or exceeding the quota.
     * @param callback.details
     */
 ...
 */
  export namespace printing {
     ...
     * PrintingAPIExtensionsWhitelist policy, the user will be prompted to accept
     * the print job.
     * @param request
     * @param callback

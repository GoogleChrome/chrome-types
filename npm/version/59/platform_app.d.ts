...
// Generated on Thu Dec 17 2020 17:47:52 GMT+1100 (Australian Eastern Daylight Time)
 ...
 */
  export namespace automation {
     ...
     */
    export type NameFromType = "uninitialized" | "attribute" | "contents" | "placeholder" | "relatedElement" | "value";
...
declare namespace chrome {
 ...
 deprecated once
   * open-web solution is available, which could be in 2017 Q2.
   * @alpha
 * @chrome-platform chromeos
 ...
 */
  export namespace clipboard {
     ...
     * @param image_data The encoded image data.
     * @param type The type of image being passed. The callback is called with <code>chrome.runtime.lastError</code> set to error code if there is an error. Requires clipboard and clipboardWrite permissions.
     * @param callback
     */
 ...
 */
  export namespace networking.onc {
    ...
    /**
     * Sets the properties of the network with id networkGuid. <b>   In kiosk
     * sessions, calling this method on a shared network will fail. </b>
     ...
     * list returned by {@link getNetworks}. This is only a request: the network
     * subsystem can choose to ignore it.  If the list is updated, then the {@link
     * onNetworkListChanged} event will be fired.
     */
    export function requestNetworkScan(): void;

    /**
     * Starts a connection to the network with networkGuid.
     * @param networkGuid The GUID of the network to connect to.
     * @param callback Called when the connect request has been sent. Note: the     connection may not have completed. Observe {@link onNetworksChanged}     to be notified when a network state changes.
     */
 ...
 */
  export namespace virtualKeyboard {
     ...
     * @param restrictions Defines the set of enabled/disabled virtual keyboard     features.
     * @param callback
     */

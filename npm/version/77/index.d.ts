...
// Generated on Thu Dec 17 2020 17:36:54 GMT+1100 (Australian Eastern Daylight Time)
 ...
 */
  export namespace automation {
     ...
     * @param attribute
     */
    export function languageAnnotationForStringAttribute(
      attribute: string,
    ): LanguageSpan[];
  }
}
 ...
 */
  export namespace declarativeNetRequest {
    ...
    export interface RuleAction {
       ...
       * specified as an absolute url or a relative url (starting with '/'), which is
       * relative to the extension which specified the rule.
       */
      redirectUrl?: string;
 ...
 */
  export namespace login {
     ...
     * @param callback Called with true if the caller extension is running in the login screen profile, or false otherwise.
     * @param callback.result
     */
    export function isRunningInLoginProfile(
      callback: (
        result: boolean,
      ) => void,
    ): void;

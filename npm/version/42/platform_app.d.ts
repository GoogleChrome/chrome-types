...
// Generated on Thu Dec 17 2020 17:49:35 GMT+1100 (Australian Eastern Daylight Time)
 ...
 */
  export namespace contentSettings {
    ...
    /**
     * Whether to allow sites to run plug-ins unsandboxed. One of
     * <br><var>allow</var>: Allow sites to run plug-ins
     * unsandboxed,<br><var>block</var>: Don't allow sites to run plug-ins
     * unsandboxed,<br><var>ask</var>: Ask when a site wants to run a plug-in
...
declare namespace chrome {
  /**
   * Use the <code>chrome.dataReductionProxy</code> API to control usage of the
   * features in Chrome that can affect a user's privacy. This API relies on the
   * <a href='types#ChromeSetting'>ChromeSetting prototype of the type API</a> for
...
declare namespace chrome {
 ...
 <p/>
 <p>Available
   * only on dev channel since Chrome 42.</p>
   * @alpha
 ...
 */
  export namespace vpnProvider {
     ...
     * @param name The name of the VPN configuration to destroy.
    ...
    export const onPlatformMessage: chrome.events.Event<
      /**
       * @param name Name of the configuration the message is intended for.
    ...
    export const onConfigRemoved: chrome.events.Event<
      /**
       * @param name Name of the configuration removed.
       */
      (
        name: string,
      ) => void

...
// Generated on Thu Dec 17 2020 17:49:20 GMT+1100 (Australian Eastern Daylight Time)
...
declare namespace chrome {
 ...
 shut
  ...
  export namespace app.runtime {
     ...
     */
    export type LaunchSource = "app_launcher" | "new_tab_page" | "reload" | "restart" | "load_and_launch" | "command_line" | "file_handler" | "url_handler" | "system_tray" | "about_page" | "keyboard" | "extensions_page" | "management_api" | "ephemeral_app" | "background" | "kiosk" | "chrome_internal" | "test";
 ...
 Window State Sample</a> for a demonstration of these options.
  ...
  export namespace app.window {
    ...
    export interface AppWindow {
       ...
       * constraints. Requires the <code>"app.window.allKeys"</code> permission. This
       * is currently available only in dev channel on Windows.
       * @param setInterceptAllKeys.wantAllKeys
       */
      setInterceptAllKeys: (
        wantAllKeys: boolean,
      ) => void;
...
declare namespace chrome {
 ...
 to transmit and receive short
   * tokens over audio.
   * @alpha
 * @chrome-permission audioModem
 */
  export namespace audioModem {
    /**
     * The audio bands supported.
     */
    export type Audioband = "audible" | "inaudible";

    export interface TokenEncoding {
      /**
       * The length of the tokens to transmit, in bytes. For now, apps must always use
    ...
    export interface RequestParams {
      /**
       * How long to transmit or receive for. The timeout has a maximum of 10 minutes
       * for transmit, or 1 hour for receive.
       */
     ...
     */
    export type Status = "success" | "invalidRequest" | "inUse" | "coderError";

    /**
     * Transmit a token. Only one can be transmitted at a time. Transmission of any
     * previous tokens (by this app) will stop.
     * @param params
     * @param token
     * @param callback A callback to report the status of a request.
    ...
    /**
     * Start listening for audio tokens. For now, only one app will be able to
     * listen at a time.
     * @param params
     * @param callback A callback to report the status of a request.
     * @param callback.status
     ...
     */
    export const onReceived: chrome.events.Event<
      /**
       * @param tokens
       */
      (
     ...
     */
    export const onTransmitFail: chrome.events.Event<
      /**
       * @param band
       */
      (
 ...
 */
  export namespace audio {
    ...
    /**
     * Sets the active devices to the devices specified by |ids|. It can pass in the
     * "complete" active device id list of either input devices, or output devices,
     * or both. If only input device ids are passed in, it will only change the
     * input devices' active status, output devices will NOT be changed; similarly
     * for the case if only output devices are passed. If the devices specified in
     * |new_active_ids| are already active, they will remain active. Otherwise, the
     * old active devices will be de-activated before we activate the new devices
     * with the same type(input/output).
     * @param ids
     * @param callback
     */
    ...
    export const OnLevelChanged: chrome.events.Event<
       ...
       * @param level new sound level of device(volume for output, gain for input).
       */
      (
        id: string,
        level: number,
    ...
    export const OnMuteChanged: chrome.events.Event<
      /**
       * @param isInput true indicating audio input; false indicating audio output.
       * @param isMuted new value of mute state.
       */
      (
        isInput: boolean,
        isMuted: boolean,
     ...
     */
    export const OnDevicesChanged: chrome.events.Event<
      /**
 ...
 */
  export namespace automation {
     ...
     */
    export type RoleType = "alertDialog" | "alert" | "annotation" | "application" | "article" | "banner" | "blockquote" | "busyIndicator" | "button" | "buttonDropDown" | "canvas" | "caption" | "cell" | "checkBox" | "client" | "colorWell" | "columnHeader" | "column" | "comboBox" | "complementary" | "contentInfo" | "date" | "dateTime" | "definition" | "descriptionListDetail" | "descriptionList" | "descriptionListTerm" | "desktop" | "details" | "dialog" | "directory" | "disclosureTriangle" | "div" | "document" | "embeddedObject" | "figcaption" | "figure" | "footer" | "form" | "grid" | "group" | "heading" | "iframe" | "iframePresentational" | "ignored" | "imageMapLink" | "imageMap" | "image" | "inlineTextBox" | "labelText" | "legend" | "lineBreak" | "link" | "listBoxOption" | "listBox" | "listItem" | "listMarker" | "list" | "locationBar" | "log" | "main" | "marquee" | "math" | "menuBar" | "menuButton" | "menuItem" | "menuItemCheckBox" | "menuItemRadio" | "menuListOption" | "menuListPopup" | "menu" | "meter" | "navigation" | "note" | "outline" | "pane" | "paragraph" | "popUpButton" | "pre" | "presentational" | "progressIndicator" | "radioButton" | "radioGroup" | "region" | "rootWebArea" | "rowHeader" | "row" | "ruby" | "ruler" | "svgRoot" | "scrollArea" | "scrollBar" | "seamlessWebArea" | "search" | "searchBox" | "slider" | "sliderThumb" | "spinButtonPart" | "spinButton" | "splitter" | "staticText" | "status" | "switch" | "tabGroup" | "tabList" | "tabPanel" | "tab" | "tableHeaderContainer" | "table" | "textField" | "time" | "timer" | "titleBar" | "toggleButton" | "toolbar" | "treeGrid" | "treeItem" | "tree" | "unknown" | "tooltip" | "webArea" | "webView" | "window";

    /**
     * Describes characteristics of an {@link automation.AutomationNode}.
     */
    export type StateType = "busy" | "checked" | "collapsed" | "default" | "disabled" | "editable" | "enabled" | "expanded" | "focusable" | "focused" | "haspopup" | "horizontal" | "hovered" | "indeterminate" | "invisible" | "linked" | "multiline" | "multiselectable" | "offscreen" | "pressed" | "protected" | "readOnly" | "required" | "selectable" | "selected" | "vertical" | "visited";
     ...
     */
    export type TreeChangeType = "nodeCreated" | "subtreeCreated" | "nodeChanged" | "nodeRemoved";
    ...
    export interface FindParams {
       ...
       * whether it should be set or not. For example: <code>{ StateType.enabled:
       * false }</code> would only match if <code>StateType.enabled</code> was
       ...
       * directory', button_mixed: true }</code>. String attribute values may be
    ...
    export interface AutomationNode {
      ...
      /**
       * The nodes, if any, which are to be considered children of this node but are
       * not children in the DOM tree.
       */
      owns: AutomationNode[];
    ...
    export interface ActiveDescendantMixin {
      /**
    ...
    export interface DocumentMixins {
      /**
    ...
    export interface ScrollableMixins {
      scrollX: number;
    ...
    export interface EditableTextMixins {
      /**
    ...
    export interface TableCellMixins {
      /**
 ...
 */
  export namespace browser {
     ...
     * new one is opened prior to creating the new tab. |options| - Configures how
     * the tab should be opened. |callback| - Called when the tab was successfully
     * created, or failed to be created. If failed, {@link runtime.lastError} will
     * be set.
     * @param options
     * @param callback
     */
 ...
 */
  export namespace contentSettings {
    ...
    export type FullscreenContentSetting = "allow" | "ask";

    export type MouselockContentSetting = "allow" | "block" | "ask";
     ...
     * those plugins that are detected as the website's main content. <br>Default is
     * <var>allow</var>.<br>The primary URL is the URL of the top-level frame. The
     * secondary URL is not used.
     */
    ...
    /**
     * Whether to allow sites to toggle the fullscreen mode. One
     * of<br><var>allow</var>: Allow sites to toggle the fullscreen
     * mode,<br><var>ask</var>: Ask when a site wants to toggle the fullscreen mode.
     * <br>Default is <var>ask</var>.<br>The primary URL is the URL of the document
     * which requested to toggle the fullscreen mode. The secondary URL is the URL
     ...
     * <br><var>allow</var>: Allow sites to disable the mouse
     * cursor,<br><var>block</var>: Don't allow sites to disable the mouse
     * cursor,<br><var>ask</var>: Ask when a site wants to disable the mouse cursor.
     * <br>Default is <var>ask</var>.<br>The primary URL is the URL of the top-level
...
declare namespace chrome {
  ...
  namespace _debugger {
     ...
     */
    export type DetachReason = "target_closed" | "canceled_by_user" | "replaced_with_devtools";
...
declare namespace chrome {
  ...
  export namespace extension {
     ...
     */
    export type ViewType = "tab" | "notification" | "popup";
 ...
 */
  export namespace fileSystemProvider {
     ...
     * if the system was shutdown. The last tag can be obtained with {@link getAll}.
     * Note, that <code>tag</code> is required in order to enable the internal
     * cache.</p><p>Value of <code>tag</code> can be any string which is unique per
     * call, so it's possible to identify the last registered notification. Eg. if
     * the providing extension starts after a reboot, and the last registered
     * notification's tag is equal to "123", then it should call {@link notify} for
     * all changes which happened since the change tagged as "123". It cannot be an
     * empty string.</p><p>Not all providers are able to provide a tag, but if the
     * file system has a changelog, then the tag can be eg. a change number, or a
     * revision number.</p><p>Note that if a parent directory is removed, then all
     * descendant entries are also removed, and if they are watched, then the API
     * must be notified about the fact. Also, if a directory is renamed, then all
     * descendant entries are in fact removed, as there is no entry under their
     * original paths anymore.</p><p>In case of an error, {@link
     * chrome.runtime.lastError} will be set will a corresponding error code.</p>
     * @param options
     * @param callback A generic result callback to indicate success or failure.
     */
 ...
 */
  export namespace fileSystem {
    ...
    export interface RequestFileSystemOptions {
      ...
      /**
       * Whether the requested file system should be writeable, or read-only. By
       * default read-only.
       */
      writable?: boolean;
    }
 ...
 */
  export namespace instanceID {
    export interface GetTokenParams {
       ...
       * this Instance ID. It can be another Instance ID or a project ID.
       */
     ...
     * @param callback.instanceID The Instance ID assigned to the app.
     */
     ...
     * defined as scope.
     * @param getTokenParams getToken parameters.
     ...
     * @param callback.token The token assigned by the requested service.
     */
     ...
     * @param deleteTokenParams deleteToken parameters.
     * @param callback Function called when the deletion completes. The token     was revoked successfully if {@link runtime.lastError} is not set.
     */
    ...
    export const onTokenRefresh: chrome.events.Event<
      /**
       * @param updateID Instance ID also needs to be refreshed.
       */
      (
        updateID: boolean,
      ) => void
 ...
 */
  export namespace notifications {
     ...
     * @param notificationId <p>Identifier of the notification. If not set or empty, an ID will automatically be generated. If it matches an existing notification, this method first clears that notification before proceeding with the create operation.</p><p>The <code>notificationId</code> parameter is required before Chrome 42.</p>
 ...
 */
  export namespace platformKeys {
    ...
    export type ClientCertificateType = "rsaSign" | "dssSign" | "ecdsaSign";
     ...
     * <code>interactive</code> is true, the user is presented a dialog where he can
     * select from matching certificates and grant the extension access to the
     ...
     * @param parameters Determines signature/hash algorithm parameters additionally   to the parameters fixed by the key itself. The same parameters are   accepted as by WebCrypto's <code>importKey</code> function, e.g.   <code>RsaHashedImportParams</code> for a RSASSA-PKCS1-v1_5 key.   For RSASSA-PKCS1-v1_5 keys, additionally the parameters   <code>{ 'hash': { 'name': 'none' } }</code> are supported. The sign   function will then apply PKCS#1 v1.5 padding and but not hash the   given data.
 ...
 */
  export namespace privacy {
    ...
    export const services: {
       ...
       * preference's value is a boolean, defaulting to <code>true</code>.
       */
      hotwordSearchEnabled: types.ChromeSetting<boolean>,
...
declare namespace chrome {
  ...
  export namespace tabs {
     ...
     * The type of window.
     */
    export type WindowType = "normal" | "popup" | "panel" | "app";
 ...
 */
  export namespace vpnProvider {
     ...
     * status.
     */
    export type PlatformMessage = "connected" | "disconnected" | "error";
     ...
     * @param callback.id A unique ID for the created configuration, empty string on failure.
     */
 ...
 */
  export namespace webRequest {
    export type ResourceType = "main_frame" | "sub_frame" | "stylesheet" | "script" | "image" | "object" | "xmlhttprequest" | "other";
  ...
  export namespace webviewTag {
    ...
    export const loadabort: chrome.events.Event<
      ...
      (
        ...
        isTopLevel: boolean,
        code: number,
        reason: "ERR_ABORTED" | "ERR_BLOCKED_BY_CLIENT" | "ERR_ADDRESS_UNREACHABLE" | "ERR_EMPTY_RESPONSE" | "ERR_FILE_NOT_FOUND" | "ERR_UNKNOWN_URL_SCHEME",
      ) => void
    >;

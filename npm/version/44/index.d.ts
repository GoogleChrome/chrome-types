 ...
 */
  export namespace declarativeContent {
     ...
     * but the extension must have a page action.  If the extension takes the <a
     * href="activeTab.html">activeTab</a> permission, a click on the page action
     ...
     * the extension must have  page or browser action.<p>Exactly one of
    ...
    export interface RequestContentScript {
      ...
      /**
       * Whether to insert the content script on about:blank and about:srcdoc. Default
       * is false.
       */

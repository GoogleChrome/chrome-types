...
// Generated on Thu Dec 17 2020 17:49:28 GMT+1100 (Australian Eastern Daylight Time)
 ...
 */
  export namespace audio {
    ...
    /**
     * Sets the active nodes to the nodes specified by |ids|. It can pass in the
     * "complete" active node id list of either input nodes, or output nodes, or
     * both. If only input node ids are passed in, it will only change the input
     * nodes' active status, output nodes will NOT be changed; similarly for the
     * case if only output nodes are passed. If the nodes specified in
     * |new_active_ids| are already active, they will remain active. Otherwise, the
     * old active nodes will be de-activated before we activate the new nodes with
     * the same type(input/output).
     * @param ids
     * @param callback
     */
    ...
    export const OnLevelChanged: chrome.events.Event<
      /**
       * @param id id of the audio node.
       * @param level new sound level of the node(volume for output, gain for input).
       */
      (
        id: string,
        level: number,
 ...
 */
  export namespace contentSettings {
     ...
     * requesting URL).
     */
    export const location: ContentSetting<"allow" | "block" | "ask">;

    /**
     * Whether to run plugins. One of<br><var>allow</var>: Run plugins
     * automatically,<br><var>block</var>: Don't run plugins automatically.
     * <br>Default is <var>allow</var>.<br>The primary URL is the URL of the
     ...
     */
    export const fullscreen: ContentSetting<"allow" | "ask">;
     ...
     */
    export const mouselock: ContentSetting<"allow" | "block" | "ask">;
     ...
     * the top-level frame. The secondary URL is not used.
     */
    export const unsandboxedPlugins: ContentSetting<"allow" | "block" | "ask">;
     ...
     * secondary URL is not used.
     */
    export const automaticDownloads: ContentSetting<"allow" | "block" | "ask">;
  }
}
 ...
 */
  export namespace dataReductionProxy {
    ...
    /**
     * Flag to indicate that dataReductionDailyContentLength and
     * dataReductionDailyReceivedLength must be updated with their latest values.
     * This preference's value is a boolean, defaulting to <code>false</code>.
     */
    export const dataReductionUpdateDailyLengths: types.ChromeSetting<boolean>;
 ...
 */
  export namespace fileSystem {
     ...
     * will be shown on top of the active app window.
     * @param options
     * @param callback
     * @param callback.fileSystem
     */
     ...
     * required. Available to kiosk apps running in the kiosk session only.
     * @param callback
 ...
 */
  export namespace webviewTag {
     ...
     * @param callback.ZoomMode The webview's current zoom mode.
     */

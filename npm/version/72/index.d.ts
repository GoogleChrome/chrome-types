 ...
 */
  export namespace declarativeNetRequest {
    ...
    export interface RuleCondition {
       ...
       * %.</p><p>Therefore <code>urlFilter</code> is composed of the following parts:
       * (optional Left/Domain name anchor) + pattern + (optional Right
       * anchor).</p><p>If omitted, all urls are matched. An empty string is not
       * allowed.</p><p>Note: The <code>urlFilter</code> must be composed of only

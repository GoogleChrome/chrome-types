...
// Generated on Thu Dec 17 2020 17:37:52 GMT+1100 (Australian Eastern Daylight Time)
 ...
 */
  export namespace automation {
     ...
     */
    export type EventType = "activedescendantchanged" | "alert" | "ariaAttributeChanged" | "autocorrectionOccured" | "blur" | "checkedStateChanged" | "childrenChanged" | "clicked" | "documentSelectionChanged" | "expandedChanged" | "focus" | "focusContext" | "imageFrameUpdated" | "hide" | "hitTestResult" | "hover" | "invalidStatusChanged" | "layoutComplete" | "liveRegionCreated" | "liveRegionChanged" | "loadComplete" | "locationChanged" | "mediaStartedPlaying" | "mediaStoppedPlaying" | "menuEnd" | "menuListItemSelected" | "menuListValueChanged" | "menuPopupEnd" | "menuPopupStart" | "menuStart" | "mouseCanceled" | "mouseDragged" | "mouseMoved" | "mousePressed" | "mouseReleased" | "rowCollapsed" | "rowCountChanged" | "rowExpanded" | "scrollPositionChanged" | "scrolledToAnchor" | "selectedChildrenChanged" | "selection" | "selectionAdd" | "selectionRemove" | "show" | "stateChanged" | "textChanged" | "textSelectionChanged" | "treeChanged" | "valueChanged";
     ...
     */
    export type StateType = "collapsed" | "default" | "editable" | "expanded" | "focusable" | "focused" | "haspopup" | "horizontal" | "hovered" | "ignored" | "invisible" | "linked" | "multiline" | "multiselectable" | "offscreen" | "protected" | "required" | "richlyEditable" | "vertical" | "visited";

    /**
     * All possible actions that can be performed on automation nodes.
     */
    export type ActionType = "blur" | "customAction" | "decrement" | "doDefault" | "focus" | "getImageData" | "hitTest" | "increment" | "loadInlineTextBoxes" | "replaceSelectedText" | "scrollBackward" | "scrollDown" | "scrollForward" | "scrollLeft" | "scrollRight" | "scrollToMakeVisible" | "scrollToPoint" | "scrollUp" | "setScrollOffset" | "setSelection" | "setSequentialFocusNavigationStartingPoint" | "setValue" | "showContextMenu";
  ...
  export namespace browserAction {
    ...
    export function setBadgeBackgroundColor(
      details: {
        /**
         * An array of four integers in the range [0,255] that make up the RGBA color of
         * the badge. Can also be a string with a CSS value, red being
         * <code>#FF0000</code> or <code>#F00</code>. Renders colors at full opacity.
         */
 ...
 */
  export namespace declarativeNetRequest {
     ...
     */
    export type ResourceType = "sub_frame" | "stylesheet" | "script" | "image" | "font" | "object" | "xmlhttprequest" | "ping" | "media" | "websocket" | "other";
     ...
     */
    export type RuleActionType = "blacklist" | "redirect" | "whitelist";
    ...
    export interface RuleCondition {
      ...
      /**
       * List of resource types which the rule can match. If the list is omitted, the
       * rule is applied to all resource types. An empty list is not allowed.
       */
      resourceTypes?: ResourceType[];

      /**
       * List of resource types which the rule won't match. If the list is empty or
     ...
     */
    export const MAX_NUMBER_OF_WHITELISTED_PAGES: number;
     ...
     * browser sessions. Note: MAX_NUMBER_OF_WHITELISTED_PAGES is the maximum number
     * of whitelisted page an extension can add. Also, adding page patterns is
     * atomic. In case of an error, no page pattern is added.
     * @param page_patterns Array of match patterns which are to be added to the whitelist.
     * @param callback Called after the |page_patterns| have been added. chrome.runtime.lastError will be set in case of an error, for example if an invalid page pattern is specified or the extension exceeded the maximum page patterns limit.
     */
    export function addWhitelistedPages(
      page_patterns: string[],
      callback?: () => void,
    ): void;

    /**
     * Removes |page_patterns| from the set of whitelisted pages. Note: Removing
     * page patterns is atomic. In case of an error, no page pattern is removed.
     * @param page_patterns Array of match patterns which are to be removed from the whitelist.
     * @param callback Called after the |page_patterns| have been removed. chrome.runtime.lastError will be set in case of an error.
     */
    export function removeWhitelistedPages(
      page_patterns: string[],
      callback?: () => void,
    ): void;
     ...
     * @param callback Called with the set of currently whitelisted pages.
     * @param callback.result
     */
    export function getWhitelistedPages(
      callback: (
        result: string[],
      ) => void,
    ): void;
 ...
 */
  export namespace system.display {
    ...
    export interface DisplayProperties {
      ...
      /**
       * Deprecated. Please use {@link setMirrorMode} instead. Chrome OS only. If set
       * and not empty, enables mirroring for this display. Otherwise disables
       * mirroring for this display. This value should indicate the id of the source
       * display to mirror, which must not be the same as the id passed to
       * setDisplayProperties. If set, no other property may be set.
       */
      mirroringSourceId?: string;
...
declare namespace chrome {
  ...
  export namespace tabs {
     ...
     * do nothing if specified tab is currently active.
     * @param highlightInfo
     * @param callback

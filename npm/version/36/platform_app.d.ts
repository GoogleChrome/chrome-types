...
// Generated on Thu Dec 17 2020 17:50:05 GMT+1100 (Australian Eastern Daylight Time)
...
declare namespace chrome {
   ...
   * none
   * @alpha
 * @chrome-permission adview
 */
  export namespace adview {
  }
}
 ...
 associated
  ...
  export namespace app.window {
    ...
    export interface FrameOptions {
       ...
       * <code>chrome</code>).<br> For <code>none</code>, the
       ...
       * disable this style on nested elements.<br>
       */
      type?: string;

      /**
       * Allows the frame color to be set. Frame coloring is only available if the
       * frame type is <code>chrome</code>.<br> Frame coloring is new in Chrome 36.
       */
      color?: string;

      /**
       * Allows the frame color of the window when active to be set. Frame coloring is
       * only available if the frame type is <code>chrome</code>.<br> Frame coloring
       * is only available if the frame type is <code>chrome</code>.<br> Frame
       * coloring is new in Chrome 36.
       */
      activeColor?: string;

      /**
       * Allows the frame color of the window when inactive to be set differently to
       * the active color. Frame coloring is only available if the frame type is
       * <code>chrome</code>.<br> <code>inactiveColor</code> must be used in
       * conjunction with <code> color</code>.<br> Frame coloring is new in Chrome 36.
       */
    ...
    export interface CreateWindowOptions {
       ...
       * draggability to the app's window. <code>-webkit-app-region: drag</code> can
       * be used to mark regions draggable. <code>no-drag</code> can be used to
       * disable this style on nested elements.<br> Use of <code>FrameOptions</code>
       * is new in M36.
       */
      ...
      /**
       * If true, the window will stay above most other windows. If there are multiple
       * windows of this kind, the currently focused window will be in the foreground.
       * Requires the <code>"alwaysOnTopWindows"</code> permission. Defaults to
       * false.<br> Call <code>setAlwaysOnTop()</code> on the window to change this
       * property after creation.<br>
       */
      alwaysOnTop?: boolean;
    ...
    export interface AppWindow {
      ...
      /**
       * Fullscreens the window.<br> The user will be able to restore the window by
       * pressing ESC. An application can prevent the fullscreen state to be left when
       * ESC is pressed by requesting the <b>overrideEscFullscreen</b> permission and
     ...
     * @param url
     * @param options
     * @param callback Called in the creating window (parent) before the load event is called in the created window (child). The parent can set fields or functions on the child usable from onload. E.g. background.js:<br> <code>function(createdWindow) { createdWindow.contentWindow.foo = function () { }; };</code> <br>window.js:<br> <code>window.onload = function () { foo(); }</code>
...
declare namespace chrome {
  ...
  export namespace automation {
     ...
     * necessary. Returns a tree with a placeholder root node; listen for the
     * "load_complete" event to get a notification that the tree has fully loaded
     * (the previous root node reference will stop working at or before this point).
 ...
 */
  export namespace bluetoothLowEnergy {
     ...
     */
    export type CharacteristicProperty = "broadcast" | "read" | "writeWithoutResponse" | "write" | "notify" | "indicate" | "authenticatedSignedWrites" | "extendedProperties" | "reliableWrite" | "writeableAuxiliaries";
    ...
    export interface Characteristic {
       ...
       * value of the characteristic is read, written, or updated via a notification
       * or indication. For local characteristics, this is the value that will be
       * returned upon requests from remote peripherals by default.
       */
      value?: ArrayBuffer;
    }
    ...
    export interface Descriptor {
       ...
       * of the descriptor is read or written. For local descriptors, this is the
       * value that will be returned upon requests from remote peripherals by default.
       */
      value?: ArrayBuffer;
    }
    ...
    /**
     * Write the value of a specified characteristic from a remote peripheral. This
     * function will fail if the characteristic is local.
     ...
     * result of a read or write request, or a value change notification or
     * indication.
     */
 ...
 */
  export namespace bluetoothSocket {
     ...
     * @param channel RFCOMM channel id to listen on. Zero may be specified to allocate an unused channel.
     * @param backlog Length of the socket's listen queue. The default value depends on the operating system's host subsystem.
    ...
    /**
     * Listens for connections from Bluetooth 1.0 and 2.0 devices using the RFCOMM
     * protocol without requiring encryption or authentication on the socket.
     * @param socketId The socket identifier.
     * @param uuid Service UUID to listen on.
     * @param channel RFCOMM channel id to listen on. Zero may be specified to allocate an unused channel.
     * @param backlog Length of the socket's listen queue. The default value depends on the operating system's host subsystem.
     ...
     * @param callback.result The result code returned from the underlying network call. A negative value indicates an error.
     */
    export function listenUsingInsecureRfcomm(
      socketId: number,
      uuid: string,
      channel: number,
      backlog: number,
     ...
     * @param socketId The socket identifier.
     * @param uuid Service UUID to listen on.
     * @param psm L2CAP PSM to listen on. Zero may be specified to allocate an unused PSM.
     * @param backlog Length of the socket's listen queue. The default value depends on the operating system's host subsystem.
     * @param callback Called when listen operation completes.
     * @param callback.result The result code returned from the underlying network call. A negative value indicates an error.
     */
 ...
 */
  export namespace bluetooth {
    ...
    export interface Profile {
      ...
      /**
       * Specifies whether pairing (and encryption) is required to be able to connect.
       */
      ...
      /**
       * Specifies whether this profile will be automatically connected if any other
       * profile of device also exporting this profile connects to the host.
       */
      autoConnect?: boolean;
    ...
    export interface SetOutOfBandPairingDataOptions {
      /**
      ...
      /**
       * The Out Of Band Pairing Data. If this is omitted, the data for the device is
       * cleared instead.
       */
    ...
    export type ReceiveError = "disconnected" | "system_error";
     ...
     * The default value is <code>false</code>. Pausing a socket is typically used
     * by an application to throttle data sent by its peer. When a socket is paused,
     * no $ref:onReceive event is raised. When a socket is connected and un-paused,
     * $ref:onReceive events are raised again when messages are received.
     * @param socketId
     * @param paused
     * @param callback
     */
    export function setSocketPaused(
      socketId: number,
      paused: boolean,
      callback?: () => void,
    ): void;
     ...
     * @param socketId The socket identifier.
     * @param callback Called when the socket state is available.
     * @param callback.socket Object containing the socket information.
     */
     ...
     * Retrieves the list of currently opened sockets owned by the application.
     * @param callback Called when the list of sockets is available.
     * @param callback.sockets Array of object containing socket information.
     */
    export function getSockets(
      callback: (
        sockets: Socket[],
     ...
     * @param callback.data
     */
    export function getLocalOutOfBandPairingData(
      callback: (
        data: OutOfBandPairingData,
      ) => void,
    ): void;
     ...
     * @param callback Called to indicate success or failure.
     */
    export function setOutOfBandPairingData(
      options: SetOutOfBandPairingDataOptions,
      callback?: () => void,
    ): void;
     ...
     */
    export const onConnection: chrome.events.Event<
      /**
 ...
 */
  export namespace cast.channel {
     ...
     * channel.errorState will be set to the error condition.</p><p>TODO(mfoltz):
     * Convert 'any' to ConnectInfo once all clients are updated to not send
     * URLs.</p>
     * @param connectInfo
 ...
 */
  export namespace fileSystemProvider {
     ...
     * <code>displayName</code> will be shown in the left panel of Files.app.
     * <code>displayName</code> can contain any characters including '/', but cannot
     * be an empty string. <code>displayName</code> should be descriptive but
     * doesn't have to be unique. Duplicate display names are uniquified by adding
     * suffix like "(1)" in the Files.app UI.
     * @param displayName
     * @param successCallback Callback to receive the result of mount() function. <code>fileSystemID</code> will be a unique ID for the file system just mounted. The ID is used to distinguish multiple file systems mounted from a single File System Provider.
     * @param successCallback.fileSystemId
     * @param successCallback.error
     * @param errorCallback Callback to handle an error raised from the browser.
    ...
    /**
     * Unmounts a file system with the given <code>fileSystemId</code>. It should be
     * called after <code>onUnmountRequested</code> is invoked. Also, the providing
     * extension can decide to perform unmounting if not requested (eg. in case of
     * lost connection, or a file error). If there is no file system with the
     * requested id, or unmounting fails, then the <code>errorCallback</code> must
     * be called.
     * @param fileSystemId
     * @param successCallback Callback to receive the result of unmount() function with the <code> fileSystemId</code> identifier.
     * @param successCallback.fileSystemId
     * @param successCallback.error
     * @param errorCallback Callback to handle an error raised from the browser.
     * @param errorCallback.error
    ...
    export const onReadDirectoryRequested: chrome.events.Event<
       ...
       * @param fileSystemId
       * @param directoryPath
       * @param successCallback Success callback for the <code>onDirectoryRequested</code> event. If more entries will be returned, then <code>hasNext</code> must be true, and it has to be called again with additional entries. If no more entries are available, then <code>hasNext</code> must be set to false.
       * @param successCallback.entries
       * @param successCallback.hasNext
       */
      (
        fileSystemId: number,
...
declare namespace chrome {
 ...
 and
   * write to a sandboxed section of the user's local file system. With this
 API,
   * Chrome Apps can read and write to a user-selected location. For
 example, a
   * text editor app can use the API to read and write local documents.
 All
 ...
 */
  export namespace hid {
    export interface HidUsageAndPage {
      usage_page: number;
     ...
     * @param callback Invoked with the <code>HidDeviceInfo</code> array on success.
     ...
     * @param callback Invoked with an <code>HidConnectInfo</code>.
    ...
    /**
     * <p>Receive an Input report from an HID device.</p><p>Input reports are
     * returned to the host through the INTERRUPT IN endpoint.</p>
     * @param connectionId The connection from which to receive a report.
     * @param size The size of the Input report to receive.
     * @param callback The callback to invoke with received report.
     * @param callback.data The content of the report.
     */
    ...
    /**
     * Send an Output report to an HID device. <code>send</code> will send the data
     * on the first OUT endpoint, if one exists. If one does not exist, the report
     * will be sent through the Control endpoint.
     * @param connectionId The connection to which to send a report.
     * @param reportId The report ID to use, or <code>0</code> if none.
     * @param data The report data.
     * @param callback The callback to invoke once the write is finished.
     */
    export function send(
      connectionId: number,
      reportId: number,
     ...
     * @param connectionId The connection to read Input report from.
     * @param reportId The report ID, or zero if none.
     * @param size The size of the Feature report to receive.
     * @param callback The callback to invoke once the write is finished.
     * @param callback.data The content of the report.
     */
    ...
    /**
     * <p>Send a Feature report to the device.</p><p>Feature reports are sent over
     * the Control endpoint as a Set_Report transfer.</p>
     * @param connectionId The connection to read Input report from.
     * @param reportId The report ID to use, or <code>0</code> if none.
     * @param data The report data.
     * @param callback The callback to invoke once the write is finished.
 ...
 */
  export namespace management {
     ...
     * shortcuts can be created. Note: This function is only available to Chrome
 ...
 */
  export namespace mediaGalleries {
    ...
    export type GetMetadataType = "all" | "mimeTypeOnly";
...
declare namespace chrome {
  ...
  export namespace tabs {
     ...
     * window. You must have <a href='declare_permissions.html'>&lt;all_urls&gt;</a>
 ...
 */
  export namespace webviewTag {
     ...
     * @param callback Called after the current zoom factor is retreived.
    ...
    /**
     * Fired when the guest window fires a <code>load</code> event.<p>The
    ...
    export const exit: chrome.events.Event<
      /**
       * @param processID Chrome's interal ID of the process that exited.
    ...
    /**
     * Fired when all loads in the guest page (including all subframes) have
     * completed. Fires in addition to any related <code>loadcommit</code> or
     * <code>loadabort</code> events, which occur per-frame.
     */
    ...
    export const permissionrequest: chrome.events.Event<
       ...
       */
      (
        permission: "media" | "geolocation" | "pointerLock" | "download" | "loadplugin",
        requestId: number,
        request: object,
      ) => void
    >;
  ...
  export namespace webview {
    ...
    export function contextMenusCreate(
      ...
      createProperties: {
         ...
         * List of contexts this menu item will appear in. Defaults to ['page'] if not
         * specified. Specifying ['all'] is equivalent to the combination of all other
         * contexts except for 'launcher'. The 'launcher' context is not supported for
         * <webview>.
         */
        contexts?: [("all" | "page" | "frame" | "selection" | "link" | "editable" | "image" | "video" | "audio" | "launcher")] & ("all" | "page" | "frame" | "selection" | "link" | "editable" | "image" | "video" | "audio" | "launcher")[],
     ...
     * @param callback Called when the context menu has been updated.
     */
    export function contextMenusUpdate(
      instanceId: number,
      id: number | string,
      updateProperties: {
        type?: "normal" | "checkbox" | "radio" | "separator",
     ...
     * @param callback Called when the context menu has been removed.
     */
    export function contextMenusRemove(
      instanceId: number,
      menuItemId: number | string,
      callback?: () => void,
    ): void;
     ...
     * @param callback Called when removal is complete.
     */
    export function contextMenusRemoveAll(
      instanceId: number,
      callback?: () => void,
    ): void;
     ...
     * @param instanceId The instance ID of the guest <webview> process.
     * @param src The src of the guest <webview> process.
     * @param details Details of the script to run.
     * @param callback Called after all the JavaScript has been executed.
     * @param callback.result The result of the script in every injected frame.
     */
     ...
     * @param instanceId The instance ID of the guest <webview> process.
     * @param zoomFactor The new zoom factor.
     * @param callback Called after the zoom message has been sent to the guest process.
     */
    export function setZoom(
      instanceId: number,
      zoomFactor: number,
     ...
     * find requests in progress.
     * @param instanceId The instance ID of the guest <webview> process.
     * @param action Determines what to do with the active match after the find session has ended. 'clear' will clear the highlighting over the active match; 'keep' will keep the active match highlighted; 'activate' will keep the active match highlighted and simulate a user click on that match.
     */
    export function stopFinding(
      instanceId: number,
      action?: "clear" | "keep" | "activate",
     ...
     */
    export function overrideUserAgent(
      instanceId: number,
    ...
    /**
     * @param instanceId The instance ID of the guest &lt;webview&gt; process. This not exposed to developers through the API.
     * @param requestId The strictly increasing request counter that serves as ID for the context menu. This not exposed to developers through the API.
     * @param itemsToShow Items to be shown in the context menu. These are top level items as opposed to children items.
     */
    export function showContextMenu(
      instanceId: number,
      requestId: number,
      itemsToShow?: ContextMenuItem[],
    ): void;

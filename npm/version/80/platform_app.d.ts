 ...
 */
  export namespace bluetooth {
     ...
     * @param filter Some criteria to filter the list of returned bluetooth devices. If the filter is not set or set to <code>{}</code>, returned device list will contain all bluetooth devices. Right now this is only supported in ChromeOS, for other platforms, a full list is returned.
...
declare namespace chrome {
   ...
   * @chrome-platform chromeos
 * @chrome-permission system.powerSource
 */
  export namespace system.powerSource {
     ...
     * @param callback.powerSourceInfo
     */
    ...
    /**
     * Requests a power source status update. Resulting power source status updates
     * are observable using {@link onPowerChanged}.
     */

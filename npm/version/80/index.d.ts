...
// Generated on Thu Dec 17 2020 17:36:38 GMT+1100 (Australian Eastern Daylight Time)
 ...
 */
  export namespace declarativeNetRequest {
     ...
     */
    export type RemoveHeaderType = "cookie" | "referer" | "setCookie";

    /**
     * Describes the kind of action to take if a given RuleCondition matches.
     */
    export type RuleActionType = "block" | "redirect" | "allow" | "upgradeScheme" | "removeHeaders";
    ...
    export interface RuleCondition {
       ...
       * instead.</p><p>Note: The <code>urlFilter</code> must be composed of only
       * ASCII characters. This is matched against a url where the host is encoded in
       * the punycode format (in case of internationalized domains) and any other
       * non-ascii characters are url encoded in utf-8. For example, when the request
       * url is http://abc.рф?q=ф, the <code>urlFilter</code> will be matched
       * against the url http://abc.xn--p1ai/?q=%D1%84.</p>
       */
      urlFilter?: string;
    ...
    export interface RuleAction {
       ...
       * "removeHeaders".
       */
      removeHeadersList?: RemoveHeaderType[];
    }
    ...
    export interface Rule {
      ...
      /**
       * Rule priority. Mandatory for redirect and upgradeScheme rules and should be
       * >= 1. This is used to break ties between multiple matching redirect rules.
       */
      priority?: number;
    ...
    export type SourceType = "manifest" | "dynamic";
    ...
    /**
     * Modify the current set of dynamic rules for the extension. The rules with IDs
     * listed in <code>rule_ids_to_remove</code> are first removed, and then the
     * rules given in <code>rules_to_add</code> are added. This update happens as a
     * single atomic operation: either all specified rules are added and removed, or
     * an error is returned. These rules are persisted across browser sessions. Any
     * ids in <code>rule_ids_to_remove</code> that are not present will be ignored.
     * Note that static rules specified as part of the extension package can not be
     * removed using this function. Note: <a
     * href="#property-MAX_NUMBER_OF_DYNAMIC_RULES"> MAX_NUMBER_OF_DYNAMIC_RULES</a>
     * is the maximum number of dynamic rules an extension can add.
     * @param rule_ids_to_remove The IDs of rules to remove.
     * @param rules_to_add The rules to add.
     * @param callback Called once the update is complete or has failed. In case of an error, {@link runtime.lastError} will be set to denote the error message and no change will be made to the rule set. This can happen for multiple reasons, such as invalid rule format, duplicate rule ID, rule count limit exceeded, internal errors, and others.
     */
    export function updateDynamicRules(
      rule_ids_to_remove: number[],
      rules_to_add: Rule[],
      callback?: () => void,
    ): void;
     ...
     * @param callback Called after the <code>page_patterns</code> have been added. {@link runtime.lastError} will be set in case of an error, for example if an invalid page pattern is specified or the extension exceeded the maximum page patterns limit.
     */
     ...
     * @param callback Called after the <code>page_patterns</code> have been removed. {@link runtime.lastError} will be set in case of an error.
     */
    ...
    /**
     * TODO(crbug.com/967942): Add documentation once implementation is complete.
     * @param filter
     * @param callback
     * @param callback.details
     */
    ...
    /**
     * Sets whether to automatically badge extension's icon to the matched action
     * count for a tab. This preference is persisted across sessions and is false by
     * default. TODO(crbug.com/973211): Add documentation once implementation is
     * complete.
     * @param enable
     */
    export function setActionCountAsBadgeText(
      enable: boolean,
    ): void;
    ...
    export const onRuleMatchedDebug: chrome.events.Event<
      /**
       * @param matched_rule_info The rule that has been matched along with information about the associated request.
       */
      (
        matched_rule_info: MatchedRuleInfoDebug,
      ) => void
    >;
  }
}
 ...
 */
  export namespace printingMetrics {
     ...
     */
    export type PrintJobSource = "PRINT_PREVIEW" | "ANDROID_APP";
...
declare namespace chrome {
  ...
  export namespace runtime {
    ...
    export interface MessageSender {
       ...
       * iframes). This is useful for identifying if the origin can be trust if we

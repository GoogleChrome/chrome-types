...
// Generated on Thu Dec 17 2020 17:36:32 GMT+1100 (Australian Eastern Daylight Time)
 ...
 */
  export namespace declarativeNetRequest {
     ...
     */
    export type RuleActionType = "block" | "redirect" | "allow" | "upgradeScheme" | "removeHeaders" | "allowAllRequests";
     ...
     * calls will fail immediately and set {@link runtime.lastError}.
     */
    ...
    /**
     * TODO(crbug.com/1044702): Add documentation once implementation is complete.
     * @param filter
     * @param callback
     * @param callback.details
     */
 ...
 */
  export namespace login {
     ...
     * @param callback Note: If the function succeeds, the callback is not guaranteed to be called as the extension will be disabled when the session starts. Use this callback only to handle the failure case by checking <code>chrome.runtime.lastError</code>.
     */

...
// Generated on Thu Dec 17 2020 17:49:15 GMT+1100 (Australian Eastern Daylight Time)
...
declare namespace chrome {
  ...
  export namespace tabs {
    export interface Tab {
      ...
      /**
       * Indicates what caused the muted setting ('', 'user', 'capture', or an
       * extension id).
       */
      mutedCause?: string;
    ...
    export const onUpdated: chrome.events.Event<
      ...
      (
        ...
        changeInfo: {
          ...
          /**
           * The tab's new muted state.
           */
          muted?: boolean,

          /**
           * When the muted state changes, indicates what caused it ('', 'user',
           * 'capture', or an extension id).
           */
          mutedCause?: string,

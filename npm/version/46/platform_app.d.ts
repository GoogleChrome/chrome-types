...
// Generated on Thu Dec 17 2020 17:49:09 GMT+1100 (Australian Eastern Daylight Time)
...
declare namespace chrome {
  ...
  export namespace certificateProvider {
    ...
    export interface SignatureDetails {
      /**
       * If the signature of the digest could not be calculated, this field must be
       * set.
       */
      error?: string;

      /**
       * If no error occurred, this field must be set to the signature of the digest
       * using the private the of the requested client certificate. For an RSA key,
       * the signature must be a PKCS#1 signature. The extension is responsible for
       * prepending the DigestInfo prefix and adding PKCS#1 padding. If an MD5_SHA1
       * hash must be signed, the extension must not prepend a DigestInfo prefix but
       * only add PKCS#1 padding.
       */
     ...
     */
    export const onClientCertificatesRequested: chrome.events.Event<
      (
        callback: (
 ...
 */
  export namespace enterprise.deviceAttributes {
     ...
     * href="https://developers.google.com/admin-sdk/directory/v1/guides/manage-chrome-devices">the device identifier of the directory API</a>, that is generated by the server and identifies the cloud record of the device for querying in the cloud directory API.
  ...
  export namespace windows {
    ...
    export function get(
      ...
      getInfo: {
         ...
         * type. If unset the default filter is set to <code>['normal', 'panel',
         * 'popup']</code>.
         */

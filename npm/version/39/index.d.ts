...
// Generated on Thu Dec 17 2020 17:49:50 GMT+1100 (Australian Eastern Daylight Time)
 ...
 */
  export namespace automation {
     ...
     */
    export type EventType = "activedescendantchanged" | "alert" | "ariaAttributeChanged" | "autocorrectionOccured" | "blur" | "checkedStateChanged" | "childrenChanged" | "focus" | "hide" | "hover" | "invalidStatusChanged" | "layoutComplete" | "liveRegionChanged" | "loadComplete" | "locationChanged" | "menuEnd" | "menuListItemSelected" | "menuListValueChanged" | "menuPopupEnd" | "menuPopupStart" | "menuStart" | "rowCollapsed" | "rowCountChanged" | "rowExpanded" | "scrollPositionChanged" | "scrolledToAnchor" | "selectedChildrenChanged" | "selectedTextChanged" | "selection" | "selectionAdd" | "selectionRemove" | "show" | "textChanged" | "textInserted" | "textRemoved" | "textSelectionChanged" | "valueChanged";
...
declare namespace chrome {
  ...
  export namespace extensionsManifestTypes {
    ...
    export interface OptionsUI {
      /**
       * The path to your options page.
       */
      page: string;

      /**
       * If <code>true</code>, a Chrome user agent stylesheet will be applied to your
       * options page. The default value is <code>false</code>.
       */
      chrome_style?: boolean;

      /**
       * If <code>true</code>, the options page will be opened in a new tab instead of
       * in an embedded popup in chrome://extensions. The default value is
       * <code>false</code>.
       */
      open_in_tab?: boolean;
    }
 ...
 */
  export namespace fileSystemProvider {
     ...
     */
    export type ProviderError = "OK" | "FAILED" | "IN_USE" | "EXISTS" | "NOT_FOUND" | "ACCESS_DENIED" | "TOO_MANY_OPENED" | "NO_MEMORY" | "NO_SPACE" | "NOT_A_DIRECTORY" | "INVALID_OPERATION" | "SECURITY" | "NOT_A_FILE" | "NOT_EMPTY" | "INVALID_URL" | "IO";
    ...
    /**
     * Unmounts a file system with the given <code>fileSystemId</code>. It must be
 ...
 */
  export namespace usb {
    ...
    export interface EnumerateDevicesAndRequestAccessOptions {
      ...
      /**
       * The interface ID to request access to. Only available on ChromeOS. It has no
    ...
    /**
     * <p>Requests access from the permission broker to a device claimed by ChromeOS
     * if the given interface on the device is not claimed.</p><p><b>Note:</b> This
     * method is ChromeOS specific. Calling this method on other platforms will
     * fail.</p>
     ...
     * interface IDs and if permissions allow opens them for use.</p><p>On Chrome
     * OS, you can specify the interface ID. In that case the method will request
     * access from permission broker in the same way as {@link
     * requestAccess}.</p><p>If the access request is rejected or the device fails
     * to be opened a connection handle will not be created or
     * returned.</p><p>Calling this method is equivalent to calling {@link
     * getDevices followed by $(ref:requestAccess} (if it is on ChromeOS) and {@link
     * openDevice} for each device.</p>
     * @param options The properties to search for on target devices.
     * @param callback

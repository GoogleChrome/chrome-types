...
// Generated on Thu Dec 17 2020 17:50:00 GMT+1100 (Australian Eastern Daylight Time)
...
declare namespace chrome {
  ...
  export namespace automation {
    ...
    export interface AutomationRootNode {
      /**
       * Whether this AutomationRootNode is loaded or not. If false, call load() to
       * get the contents.
       */
      loaded: boolean;
     ...
     * @param tabId
     * @param callback Called when the <code>AutomationRootNode</code> for the page is available.
 ...
 */
  export namespace enterprise.platformKeys {
    export interface Token {
       ...
       * <code>"user"</code> and <code>"device"</code>, referring to the platform's
       * user-specific and the device-wide hardware token, respectively. Any other
     ...
     * a device-wide TPM token is available it will also contain the device-wide
     * token with <code>id</code> <code>"device"</code>. The device-wide token will
     * be the same for all sessions on this device (device in the sense of e.g. a
     * Chromebook).
 ...
 */
  export namespace fileSystemProvider {
     ...
     * '/', but cannot be an empty string. <code>displayName</code> should be
     * descriptive but doesn't have to be unique. Duplicate display names are
     * uniquified by adding suffix like "(1)" in the Files app UI.</p><p>If a file
     * system with the passed <code>fileSystemId</code> is already mounted by this
     * extension, then <code>errorCallback</code> will be called with
     * <code>ProviderError.EXISTS</code> value. The <code>fileSystemId </code> must
     * not be an empty string.</p>
     * @param options
     * @param successCallback Callback to receive the result of mount() function.
     ...
     * requested id, or unmounting fails, then the <code>errorCallback</code> will
     * be called.
     * @param options
     * @param successCallback Callback to receive the result of unmount() function.
     * @param successCallback.error
     * @param errorCallback Callback to handle an error raised from the browser.
     * @param errorCallback.error
     */
    ...
    /**
     * Raised when opening a file at <code>filePath</code> is requested. If
     * <code>create</code> is set to <code>true</code> and the file does not
...
declare namespace chrome {
   ...
   * messages through <a href='http://developer.android.com/google/gcm/'>Google
   * Cloud Messaging</a>.
 ...
 */
  export namespace identity {
     ...
     * the profile.<br> <code>getAccounts</code> is only supported on dev channel.
     * @param callback
 ...
 */
  export namespace management {
    ...
    /**
     * Generate an app for a URL. Returns the generated bookmark app. This function
     * is new in Chrome 37.
 ...
 */
  export namespace mediaGalleries {
    ...
    export interface MediaMetadata {
       ...
       */
      attachedImages: {[name: string]: any}[];
    }
  ...
  export namespace tabs {
    ...
    export function query(
      queryInfo: {
        ...
        /**
         * Match tabs against a <a href='match_patterns'>URL pattern</a>. Note that
 ...
 */
  export namespace webview {
     ...
     * href='/extensions/content_scripts#pi'>programmatic injection</a> section of
     * the content scripts doc.
     * @param instanceId The instance ID of the guest <webview> process.
     * @param src The src of the guest <webview> tag.
     * @param details Details of the CSS text to insert.
     * @param callback Called when all the CSS has been inserted.

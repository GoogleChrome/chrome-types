...
// Generated on Thu Dec 17 2020 17:36:43 GMT+1100 (Australian Eastern Daylight Time)
 ...
 */
  export namespace declarativeNetRequest {
     ...
     * extension. These rules are persisted across browser sessions. Note: <a
     ...
     * @param callback Called once the given <code>rules</code> are added. In case of an error, {@link runtime.lastError} will be set to denote the error message and no rules will be added. This can happen for multiple reasons, such as invalid rule format, duplicate rule ID, rule count limit exceeded, internal errors, and others.
     */
    ...
    /**
     * Removes rules corresponding to <code>rule_ids</code> from the current set of
     * dynamic rules for the extension. Any <code>rule_ids</code> not already
     ...
     * @param rule_ids The IDs of dynamic rules to remove.
     * @param callback Called once the rules are removed. In case of an error, {@link runtime.lastError} will be set to denote the error message and no rules will be removed. This may happen due to internal errors.
     */
